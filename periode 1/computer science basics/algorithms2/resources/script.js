...
//delen door zichzelf en door 1
function thirdExercise(num) {
    newArray = []
    for (let i = 2; i <= num; i++) {
        if (num % i == 0) {
            newArray.push(i)
...
function fourthExercise() {
    console.log(array[parseInt(Math.random()*array.length)])
}
...
function fifthExercise() {
    ...
    while (condition) {
        ...
        Class = prompt("class")
        loek = prompt("Loek")
        if (me == "zefanja" && Class == "hard" && loek == "Awesome") {
            alert("Perfect!")
            condition = false
        } else {
...
function sixthExercise() {
    bestArray = ["rock", "paper", "scissors"]
    condition = true
    while (condition) {
        pc = bestArray[parseInt(Math.random()*bestArray.length)]
        Prompt = prompt("Rock paper scissors!")
        if (Prompt === "rock") {
            if (pc === "rock") {
                alert(`Tie! pc chose ${pc}`)
            } else if (pc === "scissors") {
                alert(`You win! pc chose ${pc}`)
                condition = false
            } else if (pc === "paper") {
                alert(`try again! pc chose ${pc}`)
            }
